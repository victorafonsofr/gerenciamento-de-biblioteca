...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ConsultarMenu.setMnemonic('h');
        ConsultarMenu.setText("Consultar");

        consultcategoriasmenu.setMnemonic('c');
        consultcategoriasmenu.setText("Categorias");
    ...
    private void consultcategoriasmenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_consultcategoriasmenuActionPerformed
        ConsultarCategoria form = new ConsultarCategoria();
        desktopPane.add(form);
        form.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_consultcategoriasmenuActionPerformed
